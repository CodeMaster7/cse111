...
Purpose: During this lesson, you will learn how to write Python code that reads text from text files.

Problem: Write a Python program named provinces.py that reads the contents of provinces.txt into a list and then modifies the list. Your program must do the following:
