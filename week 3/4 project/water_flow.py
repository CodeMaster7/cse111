...
def pressure_loss_from_pipe(pipe_diameter, pipe_length, friction_factor, water_velocity):
    ...
    pressure = -friction_factor * pipe_length * WATER_DENSITY * math.pow(water_velocity, 2) / (2000 * pipe_diameter)
    return pressure
...
def pressure_loss_from_fittings(
    ...
    # Calculate pressure loss using the formula: P = -0.04 * WATER_DENSITY * v^2 * quantity_fittings / 2000
