...
def make_periodic_table():
    """Create and return a compound dictionary that contains data for all 94 naturally occurring elements.
    Each element in the dictionary uses the element's symbol as the key and
    a list containing the element's name and atomic mass as the value.
    """
    # Create a dictionary with the symbol as the key and a list with
    # the name and atomic mass as the value
    periodic_table_dict = {
