...
Purpose: The calculator computes the molar mass of the molecule and the number of moles in the sample and then prints both of those numbers.
...
def make_periodic_table():
    """Create and return a compound list that contains data for all 94 naturally occurring elements.
    Each element in the list is a list that contains the element's symbol, name, and atomic mass.
    """
    periodic_table_list = [
...
def main():
    """
    Get user input for the molecule name and the number of moles.
    Call the make_periodic_table function to get the periodic table.
    Print the molar mass and the number of moles.
    """
    # Get a chemical formula for a molecule from the user.
    molecule_name = input("Enter the molecular formula of the sample: ")

    # Get the mass of a chemical sample in grams from the user.
    sample_mass = float(input("Enter the mass in grams of the sample: "))

    # Call make_periodic_table and store the result in a variable
    periodic_table_list = make_periodic_table()

    # Print the name and atomic mass for each element
    print("\nPeriodic Table Elements:")
    for element in periodic_table_list:
        # Print name and atomic mass, not the symbol
